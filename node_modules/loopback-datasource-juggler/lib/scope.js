...
ScopeDefinition.prototype.related = function(receiver, scopeParams, condOrRefresh, options, cb) {
  console.log("finding related model instances");
  var name = this.name;
  var self = receiver;
  ...
  if (!self.__cachedRelations || self.__cachedRelations[name] === undefined ||
      actualRefresh) {
    console.log("No cache. This is a refresh.");
    // It either doesn't hit the cache or refresh is required
    var params = mergeQuery(actualCond, scopeParams, {nestedInclude: true});
    var targetModel = this.targetModel(receiver);
    console.log("Target model is: "+ targetModel.modelName +" Params are: " + JSON.stringify(params));
    ...
    if (scopeOnRelatedModel) {
      ...
      console.log("Through model: Related query: " + JSON.stringify(queryRelated));
    ...
    targetModel.find(params, options, function(err, data) {
      ...
      console.log("related model instances are: " + data + " : " + JSON.stringify(data));
      if (scopeOnRelatedModel === true) {
        ...
        console.log("Where query for finding " + relatedModel.modelName + " is : " + JSON.stringify(queryRelated));

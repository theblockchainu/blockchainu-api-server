...
Inclusion.include = function(objects, include, options, cb) {
  ...
  function findWithForeignKeysByPage(model, filter, fkName, pageSize, options, cb) {
    ...
    console.log("Foreign keys are: " + foreignKeys.toString());
    ...
    if (pageSize <= 0) {
      console.log("pageSize 0, returning function");
  ...
  function processIncludeItem(objs, include, options, cb) {
    ...
    function includeHasManyThrough(callback) {
      console.log("Inside includeHasManyThrough");
      var sourceIds = [];
      // Map for Indexing objects by their id for faster retrieval
      var objIdMap = {};
      for (var i = 0; i < objs.length; i++) {
        var obj = objs[i];
        console.log("Processing for obj: " + JSON.stringify(obj));
        ...
        console.log("oldIdMap is: " + JSON.stringify(objIdMap));
      ...
      console.log("SourceIds are: " + JSON.stringify(sourceIds));
      ...
      function throughFetchHandler(err, throughObjs) {
        ...
        for (var i = 0; i < throughObjs.length; i++) {
          ...
          if (targetId) {
            ...
            console.log("sourceObj is: " + JSON.stringify(sourceObj));
            console.log("objList is: " + JSON.stringify(objList));
            console.log("targetIds are: " + JSON.stringify(targetIds));
          }
        }

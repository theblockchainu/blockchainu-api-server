...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 3000, host: 1290, host_ip: "localhost"
  config.vm.network "forwarded_port", guest: 7474, host: 7474, host_ip: "localhost"
  config.vm.network "forwarded_port", guest: 7687, host: 7687, host_ip: "localhost"
  config.vm.network "forwarded_port", guest: 7473, host: 7473, host_ip: "localhost"
